...
echo -e "\033[31mInstall nbextensions ...\033[0m"
$PIP install jupyter_contrib_nbextensions
jupyter contrib nbextension install

echo -e "\033[31mInstall jupyterthemes ...\033[0m"
$PIP install jupyterthemes
jt -t onedork -f roboto -fs 10 -nfs 9 -vim -T

echo -e "\033[31mInstall vim_binding ...\033[0m"
cd $jupyter_dir/nbextensions
git clone https://github.com/lambdalisue/jupyter-vim-binding vim_binding

echo -e "\033[31mEnable extensions ...\033[0m"
...
echo -e "\033[31mRestart jupyter ...\033[0m"
